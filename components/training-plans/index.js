...
import TraningPlans from "./content";

function index() {
  const [activeSection, setActiveSection] = useState("allPlans");
  return (
    <div className="mt-2">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="h-screen bg-white rounded-lg mx-2 pl-6 py-4">
            ...
            <div className="mt-2">
              <div
                ...
                onClick={() => setActiveSection("allPlans")}
              >
        ...
        <div className="col-span-3">
          {activeSection == "allPlans" && <TraningPlans />}
        </div>
      </div>
    </div>
  );
